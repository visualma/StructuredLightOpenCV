========================================================================
   APLICACIÓN: SL Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación SL.  

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación SL.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado SL.pch y un archivo de tipos 
