========================================================================
    APLICACIÓN DE CONSOLA: StructuredOpenCV_V1 Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación StructuredOpenCV_V1.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación StructuredOpenCV_V1.


StructuredOpenCV_V1.vcxproj
...
StructuredOpenCV_V1.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado StructuredOpenCV_V1.pch y un archivo de tipos precompilados llamado StdAfx.obj.
